...
function update_team_data(){
    ...
    if ( $wp_query->have_posts() ) :
        while ( $wp_query->have_posts() ) : $wp_query->the_post();
            ...
            <pre><?php //echo var_export($team_member_social_field, true); ?></pre>
                    ...
                    if(!empty($team_member_social_links)):
                        ...
                        foreach ($team_member_social_links as $socialId => $social):
                            ...
                            if(!empty($social)):
                                ...
                                $old_icon_src = isset($team_member_social_field[$socialId]['icon']) ?  $team_member_social_field[$socialId]['icon'] : '';
                                $old_icon = '<img src="'.$old_icon_src.'" />';

                                ?>

                                <pre><?php echo var_export($old_icon_src, true); ?></pre>
                                ...
                                if($socialId == 'mobile'):
                                    ...
                                    $link_list[$i]['icon'] = !empty($old_icon_src) ? $old_icon  : '<i class="fas fa-phone-square"></i>';
                                ...
                                elseif($socialId == 'website'):
                                    ...
                                    $link_list[$i]['icon'] = !empty($old_icon_src) ? $old_icon  : '<i class="fas fa-external-link-square-alt"></i>';
                                ...
                                elseif($socialId == 'email'):
                                    ...
                                    $link_list[$i]['icon'] = !empty($old_icon_src) ? $old_icon  : '<i class="fas fa-envelope-square"></i>';
                                ...
                                elseif($socialId == 'skype'):
                                    ...
                                    $link_list[$i]['icon'] = !empty($old_icon_src) ? $old_icon  : '<i class="fab fa-skype"></i>';
                                ...
                                elseif($socialId == 'facebook'):
                                    ...
                                    $link_list[$i]['icon'] = !empty($old_icon_src) ? $old_icon  : '<i class="fab fa-facebook-square"></i>';
