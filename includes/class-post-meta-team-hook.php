...
add_action('team_metabox_content_layout_builder','team_metabox_content_layout_builder');


function team_metabox_content_layout_builder($post_id){


    $settings_tabs_field = new settings_tabs_field();

    $grid_item_layout = get_post_meta($post_id,'grid_item_layout', true);
        ...
        <div class="layout-builder">
            <div class="layout-tags">
                ...
                foreach ($layout_elements_list as $elementIndex => $element):
                    ...
                    ?>
                    <span input_name="<?php echo 'grid_item_layout'; ?>"  tag_id="<?php echo $elementIndex; ?>"><?php echo $element_name; ?></span>
                    <?php
            ...
            <div class="elements expandable sortable">
                ...
                if(!empty($grid_item_layout)):
                    foreach ($grid_item_layout as $index => $item_data){
                        foreach ($item_data as $elementIndex => $element_data){

                            $args = array('input_name'=> 'grid_item_layout['.$index.']', 'element_data'=> $element_data, 'index'=>$index);
