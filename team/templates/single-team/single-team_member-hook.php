...
add_action( 'team_action_single_team_member', 'team_action_single_team_member_main_thumbnail', 10 );
...
if ( ! function_exists( 'team_action_single_team_member_main_title' ) ) {
	...
	function team_action_single_team_member_main_title() {
		...
		include( team_plugin_dir. 'templates/single-team_member-title.php');
	}
}
