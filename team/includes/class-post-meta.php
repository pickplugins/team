...
*/	
    ...
    $team_items_popup_thumb_src = get_post_meta( $post->ID, 'team_items_popup_thumb_src', true );

    if(empty($team_items_popup_thumb_src)){ $team_items_popup_thumb_src = 'featured_image'; }

    $popup_thumb_src_meta_key = get_post_meta( $post->ID, 'popup_thumb_src_meta_key', true );

	if(empty($team_items_popup_content)){ $team_items_popup_content = 'full'; }
	...
	$team_items_skill_bg_color = get_post_meta( $post->ID, 'team_items_skill_bg_color', true );
		$team_items_skill_sort = get_post_meta( $post->ID, 'team_items_skill_sort', true );
    ...
    $team_pagination_top = get_post_meta( $post->ID, 'team_pagination_top', true );
    if(empty($team_pagination_top)){$team_pagination_top = 'no';}
    ...
    $team_slide_autoplaySpeed = get_post_meta( $post->ID, 'team_slide_autoplaySpeed', true );
    $team_slide_autoplayTimeout = get_post_meta( $post->ID, 'team_slide_autoplayTimeout', true );
    $team_slide_loop = get_post_meta( $post->ID, 'team_slide_loop', true );
    $team_slide_rewind = get_post_meta( $post->ID, 'team_slide_rewind', true );
    $team_slide_center = get_post_meta( $post->ID, 'team_slide_center', true );
    $team_slide_rtl = get_post_meta( $post->ID, 'team_slide_rtl', true );
	...
	$team_id = $post->ID;
        ...
        <ul class="tab-nav">
            ...
            <li nav="7" class="nav7"><i class="fa fa-qrcode"></i> <?php _e('Slider Options','team'); ?></li>
		...
		<ul class="box">
			...
			<li style="display: none;" class="box2 tab-box">
				...
				<div class="option-box">
                    ...
                    <select name="team_items_link_to_post" >
                        ...
                        <option value="popup_slider" <?php if($team_items_link_to_post=="popup_slider")echo "selected"; ?>>Popup Slider</option>                                             
			...
			<li style="display: none;" class="box3 tab-box">
				...
				<div class="option-box">
                    ...
                    <select name="team_query_orderby" >
                        ...
                        <option value="menu_order" <?php if($team_query_orderby=="menu_order") echo "selected"; ?>><?php _e('Menu order', 'team'); ?></option>
                        <option value="meta_value" <?php if($team_query_orderby=="meta_value") echo "selected"; ?>><?php _e('Meta Value', 'team'); ?></option>
                        <option value="meta_value_num" <?php if($team_query_orderby=="meta_value_num") echo "selected"; ?>><?php _e('Meta Value(number)', 'team'); ?></option>
                        <option value="post__in" <?php if($team_query_orderby=="post__in") echo "selected"; ?>><?php _e('post__in', 'team'); ?></option>
                        <option value="post_name__in" <?php if($team_query_orderby=="post_name__in") echo "selected"; ?>><?php _e('post_name__in', 'team'); ?></option>
				...
				<div class="option-box">
                    <p class="option-title"><?php _e('Team members','team'); ?></p>
                    <p class="option-info"><?php _e('Select team member. if you want to sort team member by selected please choose Query orderby > post__in','team'); ?></p>
					<span class="update-list-team-ids button"><?php _e('Reset','team'); ?></span>
                    <br /><br />
            ...
            <li style="display: none;" class="box6 tab-box">
				<div class="option-box">
                    ...
                    <label><input <?php if($team_grid_style=='filterable') echo 'checked'; ?> type="radio" name="team_grid_style" class="team_grid_style" value="filterable" />Filterable </label>
                    <label><input <?php if($team_grid_style=='slider') echo 'checked'; ?> type="radio" name="team_grid_style" class="team_grid_style" value="slider" />Slider </label>
					...
					foreach($team_grid_items as $item_key=>$item_name){
							...
							elseif($item_key == 'popup'){
                                ...
                                <div class="options">
                                    ...
                                    <div class="option-box">
                                        <p class="option-title"><?php _e('Popup thumbnail source.','team'); ?></p>
                                        <p class="option-info"></p>
                                        <label><input <?php if($team_items_popup_thumb_src=='featured_image')echo "checked"; ?>  name="team_items_popup_thumb_src" type="radio" value="featured_image">Featured image</label>
                                        <label><input <?php if($team_items_popup_thumb_src=='meta_key')echo "checked"; ?> name="team_items_popup_thumb_src" type="radio" value="meta_key">Meta value</label>

                                        <div class="">

                                            <p class="option-info"><?php _e('Meta key.','team'); ?></p>
                                            <input name="popup_thumb_src_meta_key" type="text" value="<?php echo $popup_thumb_src_meta_key; ?>">
                                        </div>
							...
							elseif($item_key == 'skill'){
                                ...
                                <div class="options">
                                    ...
                                    <div class="option-box">
                                        <p class="option-title"><?php _e('Order','team'); ?></p>
                                        <p class="option-info"></p>
                                        <select name="team_items_skill_sort" id="team_items_skill_sort">
                                            <option <?php if($team_items_skill_sort=='none') echo 'selected'; ?> value="none"><?php echo __('None','team'); ?></option>
                                            <option <?php if($team_items_skill_sort=='DESC') echo 'selected'; ?>  value="DESC"><?php echo __('Descending','team'); ?></option>
                                            <option <?php if($team_items_skill_sort=='ASC') echo 'selected'; ?> value="ASC"><?php echo __('Ascending','team'); ?></option>
                    ...
                    <label><input <?php if($team_pagination_type=='jquery_pagination'){ echo 'checked'; } ?> type="radio" name="team_pagination_type" value="jquery_pagination" />Jquery Pagination</label>                    
					 ...
					 <script>
                        ...
                        <div class="option-box">
                            <p class="option-title"><?php _e('Pagination on top.','team'); ?></p>
                            <p class="option-info"><?php _e('Display additional pagination at top.','team'); ?></p>
                            <select name="team_pagination_top"  >
                                <option  value="no" <?php if($team_pagination_top=="no")echo "selected"; ?>><?php _e('No','team'); ?></option>
                                <option  value="yes" <?php if($team_pagination_top=="yes")echo "selected"; ?>><?php _e('Yes','team'); ?></option>
				...
				<div class="option-box">
                    <p class="option-title"><?php _e('Filterable','team'); ?></p>
            ...
            <li style="display: none;" class="box7 tab-box">
				...
				<div class="option-box">
                    ...
                    <p class="option-info">autoplay Speed</p>
                    <input type="text" id="team_slide_autoplaySpeed" name="team_slide_autoplaySpeed" value="<?php if(!empty($team_slide_autoplaySpeed)) echo $team_slide_autoplaySpeed; else echo "1000"; ?>"  />

                    <p class="option-info">autoplay Timeout</p>
                    <input type="text" id="team_slide_autoplayTimeout" name="team_slide_autoplayTimeout" value="<?php if(!empty($team_slide_autoplayTimeout)) echo $team_slide_autoplayTimeout; else echo "1200"; ?>"  />

                    <p class="option-info">Loop</p>
                    <select name="team_slide_loop">
                        <option value="true" <?php if(($team_slide_loop=="true")) echo "selected"; ?> ><?php _e('True','team');?></option>
                        <option value="false" <?php if(($team_slide_loop=="false")) echo "selected"; ?> ><?php _e('False','team');?></option>
                    </select>


                    <p class="option-info">Rewind</p>
                    <select name="team_slide_rewind">
                        <option value="false" <?php if(($team_slide_rewind=="false")) echo "selected"; ?> ><?php _e('False','team');?></option>
                        <option value="true" <?php if(($team_slide_rewind=="true")) echo "selected"; ?> ><?php _e('True','team');?></option>

                    </select>

                    <p class="option-info">Center</p>
                    <select name="team_slide_center">
                        <option value="false" <?php if(($team_slide_center=="false")) echo "selected"; ?> ><?php _e('False','team');?></option>
                        <option value="true" <?php if(($team_slide_center=="true")) echo "selected"; ?> ><?php _e('True','team');?></option>

                    </select>

                    <p class="option-info">RTL</p>
                    <select name="team_slide_rtl">
                        <option value="false" <?php if(($team_slide_rtl=="false")) echo "selected"; ?> ><?php _e('False','team');?></option>
                        <option value="true" <?php if(($team_slide_rtl=="true")) echo "selected"; ?> ><?php _e('True','team');?></option>
...
public function meta_boxes_team_save($post_id) {
  ...
  // Sanitize user input.
	...
	$team_items_popup_thumb_src = sanitize_text_field( $_POST['team_items_popup_thumb_src'] );
	$popup_thumb_src_meta_key = sanitize_text_field( $_POST['popup_thumb_src_meta_key'] );
	...
	$team_grid_meta_keys = ( $_POST['team_grid_meta_keys'] ); 
 
 	$team_items_skill_bg_color = sanitize_text_field( $_POST['team_items_skill_bg_color'] );
	$team_items_skill_sort = sanitize_text_field( $_POST['team_items_skill_sort'] );
	...
	$team_pagination_top = sanitize_text_field( $_POST['team_pagination_top'] );
    ...
    $team_slide_autoplaySpeed = sanitize_text_field( $_POST['team_slide_autoplaySpeed'] );
    $team_slide_autoplayTimeout = sanitize_text_field( $_POST['team_slide_autoplayTimeout'] );

    $team_slide_loop = sanitize_text_field( $_POST['team_slide_loop'] );
    $team_slide_rewind = sanitize_text_field( $_POST['team_slide_rewind'] );
    $team_slide_center = sanitize_text_field( $_POST['team_slide_center'] );
    $team_slide_rtl = sanitize_text_field( $_POST['team_slide_rtl'] );
  ...
  // Update the meta field in the database.
	...
	update_post_meta( $post_id, 'team_items_popup_thumb_src', $team_items_popup_thumb_src );
	update_post_meta( $post_id, 'popup_thumb_src_meta_key', $popup_thumb_src_meta_key );
	...
	update_post_meta( $post_id, 'team_items_skill_sort', $team_items_skill_sort );
	...
	update_post_meta( $post_id, 'team_pagination_top', $team_pagination_top );
    ...
    update_post_meta( $post_id, 'team_slide_autoplaySpeed', $team_slide_autoplaySpeed );
    update_post_meta( $post_id, 'team_slide_autoplayTimeout', $team_slide_autoplayTimeout );

    update_post_meta( $post_id, 'team_slide_loop', $team_slide_loop );
    update_post_meta( $post_id, 'team_slide_rewind', $team_slide_rewind );
    update_post_meta( $post_id, 'team_slide_center', $team_slide_center );
    update_post_meta( $post_id, 'team_slide_rtl', $team_slide_rtl );
