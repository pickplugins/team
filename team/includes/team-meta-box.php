...
function meta_boxes_team(){
    ...
    foreach ( $screens as $screen ){
        ...
        //add_meta_box('team_metabox_side',__('Post Grid Information', 'team'),'meta_boxes_team_side', $screen,'side');
        //add_meta_box('team_metabox_side',__('Team Information', 'team'),'meta_boxes_team_side', $screen,'side');
...
function meta_boxes_team_input( $post ) {
    ...
    $team_settings_tab[] = array(
        'id' => 'shortcode',
        'title' => __('<i class="fas fa-laptop-code"></i> Shortcode','team'),
        'priority' => 1,
        'active' => false,
    );
    ...
    $team_settings_tab[] = array(
        'id' => 'templates',
        'title' => __('<i class="fas fa-palette"></i> Templates','team'),
        'priority' => 2,
        'active' => false,
    );
    ...
    $team_settings_tab[] = array(
        'id' => 'team_members',
        'title' => __('<i class="fas fa-users"></i> Team Members','team'),
        'priority' => 2,
        'active' => true,
    );
    ...
    $team_settings_tab[] = array(
        'id' => 'slider_settings',
        'title' => __('<i class="fas fa-map"></i> Slider Settings','team'),
        'priority' => 3,
        'active' => false,
        'data_visible' => 'slider',
    ...
    $team_settings_tab[] = array(
        'id' => 'filterable',
        'title' => __('<i class="fas fa-th-large"></i> Filterable','team'),
        'priority' => 4,
        'active' => false,
    ...
    $team_settings_tab[] = array(
        'id' => 'grid',
        'title' => __('<i class="fas fa-th-large"></i> Grid','team'),
        'priority' => 4,
        'active' => false,
        'data_visible' => 'grid',
    ...
    $team_settings_tab[] = array(
        'id' => 'pagination',
        'title' => __('<i class="fas fa-th-large"></i> Pagination','team'),
        'priority' => 4,
        'active' => false,
    ...
    $team_settings_tab[] = array(
        'id' => 'masonry',
        'title' => __('<i class="fas fa-th-large"></i> Masonry','team'),
        'priority' => 4,
        'active' => false,
        'data_visible' => 'grid filterable',
        'hidden' => ($grid_type == 'slider')? true : false ,
...
//    $team_settings_tab[] = array(
//        'id' => 'custom_scripts',
//        'title' => __('<i class="far fa-file-code"></i> Custom CSS','team'),
//        'priority' => 6,
//        'active' => false,
//    );
        ...
        <div class="settings-tabs vertical">
            ...
            foreach ($team_settings_tabs as $tab){
                ...
                <div class="tab-content <?php if($active) echo 'active';?>" id="<?php echo $id; ?>">
                    <?php
                    do_action('team_meta_tabs_content_'.$id, $tab, $post_id);
                    ?>
                </div>
                <?php
            }
    ...
    <script>
        ...
        jQuery(document).ready(function($){
            ...
            $(document).on('click', '.team-meta-box .grid-type-wrap input[name="team_options[grid_type]"]', function(){
                var val = $(this).val();

                $('.team-meta-box .tab-navs li').each(function( index ) {
...
function meta_boxes_team_side( $post ) {
    ...
    <div class="post-grid-meta-box">
        ...
        <ul>
            <li>Version: <?php echo team_version; ?></li>
            <li>Tested WP: 5.1</li>
            <li>
                <?php
                ...
                if(team_customer_type=="free"){
                    ...
                    //echo '<br /><a class="button" href="'.team_pro_url.'?ref=dashboard">Buy now</a>';
        ...
        <h3>Documentation</h3>
        <a class="button" href="https://www.pickplugins.com/documentation/team/?ref=dashboard" target="_blank">Documentation</a><p class="description">Before asking, submitting reviews please take a look on our documentation, may help your issue fast.</p>
        ...
        <a class="button" href="https://wordpress.org/support/plugin/team/reviews/?filter=5" target="_blank">Submit Reviews</a> <a class="button" href="https://wordpress.org/support/plugin/team/#new-topic-0" target="_blank">Ask wordpress.org</a><p>We spent thousand+ hours to development on this plugin, please submit your reviews wisely.</p><p>If you have any issue with this plugin please submit our forums or contact our support first.</p><p class="description">Your feedback and reviews are most important things to keep our development on track. If you have time please submit us five star <a href="https://wordpress.org/support/plugin/team/reviews/?filter=5"> <span style="color: orange"><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i></span></a> reviews.</p>




        <?php
        $class_team_support = new class_team_support();
        ...
        <?php
        $video_tutorials =  $class_team_support->faq();
        ...
        <?php
        $video_tutorials =  $class_team_support->video_tutorials();
        if(!empty($video_tutorials)):
            ?>
