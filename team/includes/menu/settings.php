...
if(empty($_POST['team_hidden'])){
	...
	$team_member_display_thumbnail = get_option( 'team_member_display_thumbnail' );
		...
		if(wp_verify_nonce( $nonce, 'nonce_team' ) &&  $_POST['team_hidden'] == 'Y') {
			...
			$team_member_single_skill_sort = stripslashes_deep($_POST['team_member_single_skill_sort']);
			update_option('team_member_single_skill_sort', $team_member_single_skill_sort);

			$team_member_display_thumbnail = stripslashes_deep($_POST['team_member_display_thumbnail']);
			update_option('team_member_display_thumbnail', $team_member_display_thumbnail);
 ...
 jQuery(document).ready(function($)
	{
		$(function() {
			...
			//$( ".items" ).disableSelection();
                ...
                <div class="option-box">
                    <p class="option-title"><?php _e('Team member Single skill order.','team'); ?></p>
                    <p class="option-info"><?php _e('Single team member page skill sorting','team'); ?></p>

                    <select name="team_member_single_skill_sort">
                        <option <?php if($team_member_single_skill_sort == '') echo 'selected'; ?>  value="">None</option>
                        <option <?php if($team_member_single_skill_sort == 'ASC') echo 'selected'; ?>  value="ASC">ASC</option>
                        <option <?php if($team_member_single_skill_sort == 'DESC') echo 'selected'; ?> value="DESC">DESC</option>
                    </select>
                ...
                <div class="option-box">
                    <p class="option-title"><?php _e('Display thumbnail on single team member page?','team'); ?></p>
                    <p class="option-info"><?php _e('If your themes is not showing featured image or thumbnail you can activate from here','team'); ?></p>

                    <select name="team_member_display_thumbnail">
                        <option <?php if($team_member_display_thumbnail == 'no') echo 'selected'; ?>  value="no">No</option>
                        <option <?php if($team_member_display_thumbnail == 'yes') echo 'selected'; ?>  value="yes">Yes</option>
                    </select>
