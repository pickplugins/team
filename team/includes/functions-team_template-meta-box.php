...
<!--                                <span class="move"><i class="fa fa-bars"></i></span>-->
            ...
            <div class="team-container">
                <div class="team-grid-item-preview">
            ...
            <style type="text/css">
                ...
                .team-grid-item-preview {
                    padding: 35px 95px;
                    background: url(<?php echo team_plugin_url; ?>/assets/admin/images/tile.png);
                }
...
if(!function_exists('team_template_meta_tabs_content_popup_template')) {
    function team_template_meta_tabs_content_popup_template($tab, $post_id){
        ...
        <div class="section">
                            ...
                            <div class="options">
                                ...
                                if(!empty($element_settings)):
                                    foreach ($element_settings as $option){
                                        ...
                                        $option['css_id'] = 'popup-'.$layout_item_key.'-'.$option['id'];
            ...
            <div class="team-container">
                <div class="team-popup-box-preview team-popup-box">
            ...
            <style type="text/css">
                .team-popup-box-preview {
                    padding: 35px 95px;
                    background: url(<?php echo team_plugin_url; ?>/assets/admin/images/tile.png);
                }

                .team-popup-box-preview .item-wrap{
                    width: 90%;
                    margin: 90px auto;
                    background: #fff;
                    position: relative;
                ...
                .team-popup-box-preview .item-wrap .close{
                    position: absolute;
                    background: #ea4f11;
                    color: #fff;
                    padding: 5px 10px;
...
add_action('team_template_meta_tabs_content_single_member_teamplate', 'team_template_meta_tabs_content_single_member_teamplate',10, 2);

if(!function_exists('team_template_meta_tabs_content_single_member_teamplate')) {
    function team_template_meta_tabs_content_single_member_teamplate($tab, $post_id){

        $class_team_functions = new class_team_functions();
        $settings_tabs_field = new settings_tabs_field();
        //$layout_templates = $class_team_functions->layout_templates();
        $single_team_layout_items = $class_team_functions->layout_items();




        $team_template_options = get_post_meta( $post_id, 'team_template_options', true );
        $template_single_team_layout_items = isset($team_template_options['single_team_layout_items']) ? $team_template_options['single_team_layout_items'] : array();
        $single_team_layout_items_sort = isset($team_template_options['single_team_layout_items_sort']) ? $team_template_options['single_team_layout_items_sort'] : array();
        $template = isset($team_template_options['template']) ? $team_template_options['template'] : 'templateA';

        //$template_single_team_layout_items = isset($layout_templates[$template]) ? $layout_templates[$template] : $template_single_team_layout_items;

        //$single_team_layout_items_sort = !empty($single_team_layout_items_sort) ? $layout_templates[$template] : $single_team_layout_items_sort;

        $single_team_template_html = isset($team_template_options['single_team_template_html']) ? $team_template_options['single_team_template_html'] : '';
        $single_team_template_css = isset($team_template_options['single_team_template_css']) ? $team_template_options['single_team_template_css'] : '';
        ...
        <div class="section">
            ...
            <div class="expandable">
                ...
                <?php
                if(!empty($single_team_layout_items_sort)):
                    foreach ($single_team_layout_items_sort as $layout_item_key=>$layout_item_val):
                        $title = $single_team_layout_items[$layout_item_key]['title'];
                        $options_style = $single_team_layout_items[$layout_item_key]['style'];
                        $element_settings = isset($single_team_layout_items[$layout_item_key]['settings']) ?$single_team_layout_items[$layout_item_key]['settings'] : array();
                        ...
                        <div class="item">
                            <div class="header">
                                ...
                                <span class="expand"><i class="fa fa-expand"></i><i class="fa fa-compress"></i></span>
                                <span class="name"><?php echo $title; ?> <code><?php echo $layout_item_key; ?></code> </span>
                                <input type="hidden" name="team_template_options[single_team_layout_items_sort][<?php echo $layout_item_key; ?>]" value="">
                            ...
                            <div class="options">
                                ...
                                if(!empty($element_settings)):
                                    foreach ($element_settings as $option){
                                        ...
                                        $option['css_id'] = 'single-'.$layout_item_key.'-'.$option['id'];
                                        $option['parent'] = 'team_template_options[single_team_layout_items]['.$layout_item_key.'][settings]';
                                        $option['value'] = isset($template_single_team_layout_items[$layout_item_key]['settings'][$option['id']]) ? $template_single_team_layout_items[$layout_item_key]['settings'][$option['id']] : '';
                                ...
                                if(!empty($options_style)):
                                    foreach ($options_style as $option){
                                        ...
                                        $option['css_id'] = 'single-'.$layout_item_key.'-'.$option['id'];
                                        $option['parent'] = 'team_template_options[single_team_layout_items]['.$layout_item_key.'][style]';
                                        $option['value'] = isset($template_single_team_layout_items[$layout_item_key]['style'][$option['id']]) ? $template_single_team_layout_items[$layout_item_key]['style'][$option['id']] : '';
                    ...
                    foreach ($single_team_layout_items as $layout_item_key=>$layout_item_val):
                        $title = $single_team_layout_items[$layout_item_key]['title'];
                        $options_style = $single_team_layout_items[$layout_item_key]['style'];
            ...
            $args = array(
                'id' => 'single_team_template_html',
                'parent' => 'team_template_options',
                'title' => __('Template HTML', 'team'),
                'details' => 'you can use custom html for item output, <code>'.esc_html($details).'</code>',
                'type' => 'textarea',
                'value' => $single_team_template_html,
                'default' => '',
            ...
            $args = array(
                'id'		=> 'single_team_template_css',
                'parent' => 'team_template_options',
                'title'		=> __('Custom CSS','team'),
                'details'	=> __('Add your own CSS..','team'),
                'type'		=> 'scripts_css',
                'value'		=> $single_team_template_css,
                'default'		=> '.item-wrap{}&#10;.item-wrap .element.thumbnail{}&#10;',
            );
            ...
            <div class="team-container">
                <div class="team-single-item-preview team-single-box">

                    <?php echo strtr($single_team_template_html,$vars); ?>
                </div>

            </div>
            <style type="text/css">
                .team-single-item-preview {
                    padding: 35px 95px;
                    background: url(<?php echo team_plugin_url; ?>/assets/admin/images/tile.png);
                }
                ...
                echo $single_team_template_css;



                foreach ($template_single_team_layout_items as $layout_item_key=>$layoutData):
